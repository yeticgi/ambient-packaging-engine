...
// { FlagA: true, FlagB: false, FlagC: false }

f.set(true, 'FlagB', 'FlagC');
// { FlagA: true, FlagB: true, FlagC: true }

f.toggle('FlagA');
// { FlagA: false, FlagB: true, FlagC: true }
...
f.toggle('FlagB');
// { FlagA: false, FlagB: false, FlagC: true }
...
const lastFlag = f.flagFromIndex(f.flagCount - 1);
// 'FlagC'

if (lastFlag) {
    f.set(false, lastFlag);
    // { FlagA: true, FlagB: true, FlagC: false }
}